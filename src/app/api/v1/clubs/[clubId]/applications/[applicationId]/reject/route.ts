...
export async function POST(req: NextRequest, ctx: Ctx) {
  ...
  db.notifications.push({
    id: uuid(), userId: db.applications[idx].userId, type: 'APPLICATION_REJECTED',
    title: 'Application Rejected',
    body: `Your application to join ${club?.name || 'the club'} was not approved.`,
    clubId, read: false, createdAt: new Date().toISOString(),
  });
